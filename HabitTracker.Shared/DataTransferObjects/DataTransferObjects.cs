...
{
    public record HabitDto(int Id, string Name, string Description, [AllowNull] HabitList HabitList,[AllowNull] ICollection<HabitCompleteStatus> DailyCompleteStatus);
